...
<body>
	...
	<table class="table">
			...
			<c:forEach var="carpool" items="${adminCpList }">
				<tr>
					...
					<td class="col-md-2 text-center">
						...
						<c:if test="${carpool.RSV_confirm == 'N' && carpool.RSV_mConfirm == 'N' }">매칭거절</c:if>
					</td>
				</tr>
			</c:forEach>
		</c:if>
		...
		<form action="adminCpList.do">
			...
			<select name="search">
				<c:forTokens var="sh" items="MB_nickName,CP_startPoint,CP_endPoint" delims="," varStatus="i">
