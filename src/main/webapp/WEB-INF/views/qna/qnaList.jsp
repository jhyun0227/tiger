				...
				<tr>
					<c:if test="${qna.QA_del != 'Y' }">
						...
						<td class="col-md-10 text-left title_left">
							<a href="qnaView.do?num=${qna.QA_num }&pageNum=${pb.currentPage}"
	...
	<div align="center">
		<ul class="pagination_bottom">
			...
			<c:if test="${pb.startPage > pb.pagePerBlock }">
				<li>
					<a href="qnaList.do?pageNum=1&search=${qna.search }&keyword=${qna.keyword}"
						class="page_num"><span class="glyphicon glyphicon-backward"></span></a></li>
				<li>
					<a href="qnaList.do?pageNum=${pb.pagePerBlock }&search=${qna.search }&keyword=${qna.keyword}"
			...
			<c:if test="${pb.endPage < pb.totalPage }">
				<li><a href="qnaList.do?pageNum=${pb.endPage+1 }&search=${qna.search }&keyword=${qna.keyword}"
						class="page_num"><span class="glyphicon glyphicon-triangle-right"></span>
				</a></li>
				<li><a href="qnaList.do?pageNum=${pb.totalPage }&search=${qna.search }&keyword=${qna.keyword}"
