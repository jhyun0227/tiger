...
<body>
	<div align="center">
		...
		<div align="center">
			...
			<div align="right">
				<a href="adminCpList.do?pageNum=${pageNum }" class="btn_prev">목록</a>
				<c:if test="${memberDB.MB_id == 'admin' }">
					<a href="adminCpDelete.do?CP_num=${carpool.CP_num }&pageNum=${pageNum }" class="btn_prev">삭제</a>
				</c:if>
			</div>
		</div>
	</div>
